...
const sponsors = [
  ...
  { name: 'Monster Energy', color: '#1e7a1e' },
  { name: 'Gatorade', color: '#005eb8' },
  { name: 'Burn', color: '#ed1c24' },
  { name: 'Powerade', color: '#0d5e9e' },
  { name: 'Coca-Cola', color: '#ed1c16' },
  { name: 'Pepsi', color: '#003da5' },
  { name: 'Schweppes', color: '#6b8e23' },
  { name: 'Fanta', color: '#ff7300' },
  { name: 'Sprite', color: '#35a535' },
  { name: 'Miranda', color: '#f58220' },
  { name: 'Oasis', color: '#e87b2a' },
